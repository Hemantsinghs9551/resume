...
class resume{
    public static void intro(){
        ...
        System.out.println("Name-HEMANT SINGH");
        System.out.println("Contact - 7898687705");
        System.out.println("E-mail = hemantsinghs9551@gmail.com");
    ...
    public static void acadamic_qualification(){
        ...
        System.out.println("2              Intermediate   M.P. Board           2020            1st Division");
    ...
    public static void factor(){
        ...
        System.out.println("Father Name - SHAILENDRA KUMAR SINGH");
        System.out.println("Date of Birth - 08/02/2003");
    ...
    public static void project(){
        ...
        System.out.println("1.basic calculater gui : Built a basic calculater using java");
        System.out.println("2.Google Translate : Build a basic google translate using python");
        System.out.println("3.Bus reservation system :Build a basic bus reservation system using cpp");
        System.out.println("4.Database managment system : Build a basic dbms system using cpp");
        System.out.println("____________________________");
        System.out.println("____________________________");
    }
